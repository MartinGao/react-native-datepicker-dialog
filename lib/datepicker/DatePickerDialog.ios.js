            ...
            <View style={{flexDirection:'row'}}>
              <View style={styles.modalContent}>
                <View style={{marginTop: 24, marginLeft: 8, marginRight:8}}>
                  ...
                  />
                  <View style={{flexDirection: 'row'}}>
                    <TouchableHighlight style={{flex:1, height: 30, justifyContent: 'center',  alignItems: 'center',}} onPress={this.cancel.bind(this)} underlayColor={"#57D4E8"}>
                      <View style={{}}><Text style={styles.buttonTextStyle}>{this.props.cancelLabel}</Text></View>
                    </TouchableHighlight>
                    <TouchableHighlight style={{flex:1, height: 30, justifyContent: 'center',  alignItems: 'center',}} onPress={this.ok.bind(this)} underlayColor={"#57D4E8"}>
